...
class NeuralNetwork():
    ...
    def train(self, training_set_inputs, training_set_outputs, number_of_training_iterations):
        for iteration in range(number_of_training_iterations):
            print("Iteration %s: synaptic weights before training %s" % (iteration, str(self.synaptic_weights.T)))
            ...
            print("Iteration %s: output                           %s" % (iteration, str(output.T)))
            print("Iteration %s: error                            %s" % (iteration, str(np.mean(np.abs(error)))))
            print("Iteration %s: adjustment                       %s" % (iteration, str(adjustment.T)))
            print("Iteration %s: synaptic weights after training  %s" % (iteration, str(self.synaptic_weights.T)))
            print()
